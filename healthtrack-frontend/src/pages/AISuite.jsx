            ...
            <div className="bg-white/75 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-100 dark:border-gray-700 rounded-3xl shadow-2xl p-6 md:p-8 flex flex-col h-[650px] relative overflow-hidden">
                  ...
                  >
                    <div
                      className={`max-w-[75%] p-4 rounded-2xl shadow-md text-sm leading-relaxed whitespace-pre-line ${
                        h.sender === 'user'
                          ? 'bg-gradient-to-r from-accent-from to-accent-to text-white rounded-tr-none'
              ...
              <form onSubmit={handleSendChat} className="pt-4 border-t border-gray-100 dark:border-gray-700 flex gap-3">
                <input
                  ...
                  className="flex-1 px-5 py-3.5 border-2 border-gray-300 dark:border-gray-600 rounded-2xl focus:outline-none focus:ring-2 focus:ring-accent-primary dark:bg-gray-750 dark:text-gray-200 font-medium shadow-inner"
                />
                <button
                  type="submit"
                ...
                <form onSubmit={handleGenerateDiet} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-accent-primary/30 dark:border-accent-primary/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-primary dark:bg-gray-750 dark:text-gray-200 font-medium"
                    />
                  </div>
                  <div>
                    <label className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                ...
                {dietPlan && (
                  <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-100 dark:border-gray-700 rounded-3xl p-6 md:p-8 shadow-2xl space-y-8">
                    <div className="flex flex-wrap justify-between items-center gap-4 pb-6 border-b border-gray-100 dark:border-gray-700">
                      ...
                      <div className="bg-accent-primary/10 border border-accent-primary/30 px-5 py-3 rounded-2xl text-center">
                        <span className="text-xs font-bold text-accent-primary uppercase tracking-wide">Daily Calories</span>
                        <p className="text-3xl font-black text-accent-primary mt-0.5">{dietPlan.dailyCaloriesTarget} kcal</p>
                      </div>
                    </div>
                    ...
                    {/* Pro Health Tips */}
                    {dietPlan.tips && (
                      <div className="p-5 bg-gradient-to-r from-accent-from/10 to-accent-to/10 rounded-2xl border border-accent-primary/20">
                ...
                <form onSubmit={handleGenerateWorkout} className="space-y-5">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border-2 border-accent-primary/30 dark:border-accent-primary/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-primary dark:bg-gray-750 dark:text-gray-250 font-medium"
                    >
                ...
                {workoutPlan && (
                  <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-100 dark:border-gray-700 rounded-3xl p-6 md:p-8 shadow-2xl space-y-8">
                    <div className="flex flex-wrap justify-between items-center gap-4 pb-6 border-b border-gray-100 dark:border-gray-700">
                      ...
                      <div className="bg-accent-primary/10 border border-accent-primary/30 px-5 py-3 rounded-2xl text-center">
                        <span className="text-xs font-bold text-accent-primary uppercase tracking-wide">Workouts</span>
                        <p className="text-3xl font-black text-accent-primary mt-0.5">{workoutPlan.weeklyFrequency} / week</p>
                      </div>
                    </div>
